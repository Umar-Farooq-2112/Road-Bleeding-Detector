...
def detectRoadBleed(image,mask,pothole,shadow_filter,threshold = 15,dark_spots_threshold = 50,name = ''):
    
    if image is None or mask is None or pothole is None or shadow_filter is None:
        return None
