...
def detectRoadBleed(image,mask,pothole,threshold = 15,name = ''):
    ...
    # cv2.imwrite(f'{name}_filters',resize_image(joined1))
    # cv2.imwrite(f'{name}_results',resize_image(joined2))
